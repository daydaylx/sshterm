...
class ResolveTargetUseCase @Inject constructor(
     ...
     */
    fun isTailscaleTarget(targetType: com.dlx.sshterm.domain.model.NetworkTargetType): Boolean {
        return targetType == com.dlx.sshterm.domain.model.NetworkTargetType.TAILSCALE
    }
}
