package com.dlx.sshterm.ui.hostedit
...
import com.dlx.sshterm.presentation.hostedit.HostEditUiState
import com.dlx.sshterm.presentation.hostedit.HostEditViewModel
...
import com.dlx.sshterm.ui.components.InlineLoadingView
                    ...
                    if (!uiState.hasStoredPrivateKey || privateKeyPem.isNotBlank()) {
                        Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                            ...
                            OutlinedButton(
                                ...
                                Text(stringResource(R.string.host_edit_load_key_file))
                            }
