    ...
    SwipeToDismissBox(
        ...
        OutlinedCard(
            ...
            Row(
                ...
                // Swipe direction hint indicators (subtle)
                Box(
                    modifier = Modifier
                        .size(4.dp)
                        .background(
                            color = AppTheme.success.copy(alpha = 0.4f),
                ...
                Column(
                    ...
                    // Quick-connect button (visible alternative to swipe)
                    FilledTonalIconButton(
                        ...
                        Icon(
                            ...
                            contentDescription = stringResource(R.string.host_card_connect),
                ...
                // Subtle delete hint indicator (right edge)
                Box(
                    modifier = Modifier
                        .size(4.dp)
                        .background(
                            color = AppTheme.danger.copy(alpha = 0.3f),
                            shape = androidx.compose.foundation.shape.CircleShape
                        )
                )
